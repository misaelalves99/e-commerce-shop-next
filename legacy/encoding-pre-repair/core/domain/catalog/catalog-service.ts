...
/**
 * Filtra a lista de produtos com base em m̼ltiplos crit̩rios.
 * Fun̤̣o pura, ideal para ser usada em hooks/contexts.
 */
...
/**
 * Ordena produtos com base em uma estrat̩gia de ordena̤̣o.
 */
export function sortProducts(products: Product[], sortBy: CatalogSortOption): Product[] {
  ...
  switch (sortBy) {
    ...
    case 'newest':
      // ṇo temos data de cria̤̣o aqui; podemos usar ratingCount como proxy
      return clone.sort((a, b) => b.ratingCount - a.ratingCount);
    case 'relevance':
    default:
      // "Relev̢ncia" simples: featured primeiro, depois rating e desconto
      return clone.sort((a, b) => {
...
/**
 * Retorna os produtos mais bem avaliados (para se̤̣o "avaliados").
 */
