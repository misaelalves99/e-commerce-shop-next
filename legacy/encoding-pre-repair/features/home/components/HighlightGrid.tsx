...
export interface HighlightSection {
  ...
  subtitle?: string;
  products: Product[];
  /** Link opcional "ver todos" da seÃ§Ã£o */
  href?: AppRoute;
}
...
export const HighlightGrid: React.FC<HighlightGridProps> = ({ sections }) => {
  ...
  return (
    <section className={styles.grid} aria-label="SeÃ§Ãµes de destaques do catÃ¡logo">
                    ...
                    <div className={styles.productMeta}>
                      <div className={styles.productRatingRow}>
                        ...
                        <span className={styles.productReviews}>
                          {product.ratingCount.toLocaleString('pt-BR')} avaliaÃ§Ãµes
                        </span>
                      </div>
