    ...
    <section className="page-container">
      <header className="page-header">
        <div className="page-header__left">
          <p className="eyebrow-label">CatÃ¡logo completo</p>
          <h1 className="page-title">Encontre tudo em um sÃ³ lugar</h1>
          <p className="page-subtitle">
            Filtre por categoria, preÃ§o e ofertas para encontrar os melhores
            produtos com frete rÃ¡pido e pagamento seguro.
          </p>
        </div>
      </header>
