  ...
  return (
    <section className={styles.cartSection} aria-label="Comprar produto">
      ...
      <ul className={styles.cartBenefits}>
        <li>âœ” Pagamento seguro com cartÃµes, PIX e boleto.</li>
        <li>âœ” AtÃ© 10x sem juros em cartÃµes selecionados.</li>
        <li>âœ” PolÃ­tica de troca simplificada diretamente no painel do cliente.</li>
      </ul>
    </section>
  );
}
