      ...
      <div className={styles.infoColumn}>
        ...
        <div className={styles.textBox}>
          ...
          <p className={styles.meta}>
            Envio rÃ¡pido â€¢ DevoluÃ§Ã£o grÃ¡tis â€¢ Garantia estendida opcional
          </p>

          <div className={styles.tagsRow}>
            <span className={styles.tagHighlight}>Frete rÃ¡pido</span>
            <span className={styles.tagMuted}>DevoluÃ§Ã£o em atÃ© 7 dias</span>
          </div>
        ...
        <div className={styles.bottomRow}>
          <div className={styles.quantityWrapper}>
            ...
            {isMaxReached ? (
              <span className={styles.stockHintDanger}>
                MÃ¡ximo disponÃ­vel para este produto
              </span>
            ) : (
              <span className={styles.stockHint}>
                {item.quantity <= 3
                  ? 'Em estoque â€¢ Ãºltimas unidades'
                  : 'Em estoque'}
              </span>
            )}
          </div>
          ...
          <div className={styles.actionsRow}>
            <button
              ...
              // futura implementaÃ§Ã£o: mover para "salvos"
              onClick={handleRemove}
            >
              Salvar para depois
            </button>
