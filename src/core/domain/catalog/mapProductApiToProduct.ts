...
/**
 * Calcula o percentual de desconto com base no preço atual e antigo.
 */
...
/**
 * Mapa de categorias para consulta rápida por id.
 */
...
export function mapProductApiToProduct(
  ...
  return {
    ...
    installmentValue,
    /**
     * Sugestão: custo estimado no PIX com pequeno desconto adicional
