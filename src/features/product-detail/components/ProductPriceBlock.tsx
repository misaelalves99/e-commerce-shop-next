...
export default function ProductPriceBlock({
  ...
  return (
    <section className={styles.priceSection} aria-label="Informações de preço">
      <div className={styles.priceRow}>
        <div className={styles.priceColumn}>
          ...
          <p className={styles.pixText}>
            <span className={styles.pixHighlight}>
              {priceBRL(price * 0.96)} à vista no PIX
            </span>
        ...
        {freeShipping && (
          <div className={styles.shippingBadge}>
            <span className={styles.shippingLabel}>Frete grátis</span>
