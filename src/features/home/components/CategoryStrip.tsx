...
export interface CategoryStripProps {
  ...
  /** Título opcional acima da faixa (ex.: "Compre por categoria") */
  title?: string;
  /** Se true, mostra os botões de navegação lateral no desktop */
...
export const CategoryStrip: React.FC<CategoryStripProps> = ({
  ...
  return (
    <section className={styles.strip} aria-label="Categorias do catálogo">
                  ...
                  <span className={styles.categoryContent}>
                    {category.icon && (
                      <span className={styles.categoryIcon} aria-hidden="true">
                        {/* Ícone é opcional; você pode mapear o slug do ícone em shared/icons */}
