...
const NAV_LINKS: Array<{
  ...
  { label: 'Catálogo', href: '/products', icon: FiTag },
...
export function Header() {
  ...
  return (
    <header className={styles.header}>
      {/* Top bar (promo / mensagem rápida) */}
      <div className={styles.topBar}>
        <div className={styles.topBarContent}>
          <span className={styles.topBarHighlight}>Frete rápido</span>
          <span className={styles.topBarText}>
            Aproveite ofertas relâmpago e descontos exclusivos hoje.
          </span>
        </div>
      </div>
      ...
      {/* Navegação secundária (links principais) */}
